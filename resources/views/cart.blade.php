...
<table id="cart" class="table table-hover table-condensed">
            ...
            <td data-th="Product">
                <div class="row">
                    <div class="col-sm-3 hidden-xs">
                        <img src="{{$details['photo'] }}" width="100" height="100" class="imgresponsive" />
                    </div>
                    <div class="col-sm-9">
    ...
    <tfoot>
        ...
        <tr>
            <td>
                <a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continuare Cumparaturi</a>
                <a href="{{ url('/stripe-payment?total=' . $total) }}" class="btn btn-success"><i class="fa fa-credit-card"></i> Buy Now</a>
            </td>
